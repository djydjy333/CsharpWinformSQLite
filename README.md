...
├── MainForm.cs              # 源代码（含 LoginForm 和 MainForm）
├── MyApp.exe                # 可执行文件
├── build.bat                # 编译脚本
├── README.md                # 说明文档
...
$ref = 'packages\Stub.System.Data.SQLite.Core.NetFramework.1.0.119.0\lib\net40\System.Data.SQLite.dll'
& $csc /target:winexe /out:MyApp.exe /r:$ref MainForm.cs
```
...
MainForm.cs
├── LoginForm 类（登录窗体）
│   ├── InitializeForm()      - 初始化登录界面
│   ├── InitializeDatabase()  - 创建用户表
